  ...
  return (
    <div className={css.homePage}>
      ...
      <p className={css.intro}>
        ...
        ourselves on making car renting a hassle-free process, ensuring that your journey begins the
        moment you choose us. Embark on an unforgettable journey today with our reliable,
